...
```bash
cd ~/Downloads
git clone https://github.com/obsidianmd/obsidian/releases/releases/download/v1.5.8/obsidian_1.5.8_amd64.deb
sudo dpkg -i obsidian_1.5.8_amd64.deb
cd ~
git clone https://github.com/Photin1a/photiniaNote.git
```
### Todesk远程
```sh
